...
class calcRule {
  static const String fu_nashi = "符計算なし";
  static const String pintsumo_chitoi_fu_ari = "ピンツモ,チートイのみ符計算";
  static const String pintumo_fu_ari = "ピンツモのみ符計算";
  static const String chitoi_fu_ari = "チートイのみ符計算";
  static const String fu_ari = "符計算あり";
}
